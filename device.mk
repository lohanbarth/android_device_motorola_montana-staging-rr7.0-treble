...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/media_profiles_8956.xml:$(TARGET_COPY_OUT_VENDOR)/vendor/etc/media_profiles_8956.xml
...
PRODUCT_COPY_FILES += $(LOCAL_PATH)/configs/thermal-engine-montana.conf:$(TARGET_COPY_OUT_VENDOR)/etc/thermal-engine.conf
